                        ...
                        <table className="w-full table-auto">
                            <thead>
                                <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                    ...
                                    <th className="py-3 px-2 text-center">Payment Menthod</th>
                                ...
                                {orders.map(order => <tr className="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td className="py-3 px-2 text-center">
                                        {order.id === editableOrder ? (
                                            ...
                                            (<span className={`${changeColor(order.status)} py-1 px-3 rounded-full text-xs`}>
                                                {order.status}
                                            </span>)}
                                    </td>
                                    <td className="py-3 px-2 text-center">
                                    ...
                                    <td className="py-3 px-2 text-center">
                                        {order.id === editableOrder ? (
                                            ...
                                            (<span className={`${changeColor(order.paymentStatus)} py-1 px-3 rounded-full text-xs`}>
                                                {order.paymentStatus}
                                            </span>)}
                                    </td>
                                    <td className="py-3 px-2 text-center">
